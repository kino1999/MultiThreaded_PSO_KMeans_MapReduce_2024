...
public class PSOKMeans {
    ...
    public PSOKMeans(int numParticles, int maxIterations, int k, List<double[]> data,double w,double c1,double c2,List<double[]>positions) {
    ...
    private List<Double> evaluate(List<double[]> positions) {
        ...
        for (double[] individual : positions) {
